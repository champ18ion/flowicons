  ...
  (
    ...
    return (
      <motion.svg
        ...
        whileTap={{ scale: 0.95 }}
      >
        <motion.ellipse cx="12" cy="5" rx="9" ry="3" className="icon-element" /><motion.path d="M3 5V19A9 3 0 0 0 21 19V5" className="icon-element" /><motion.path d="M3 12A9 3 0 0 0 21 12" className="icon-element" />
      </motion.svg>
    );
  }
);
