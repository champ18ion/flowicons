...
const MapPin = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    const loadingAnim = useCallback(() => {
      animate(".icon-element", { y: [0, -3, 0] }, { duration: 0.8, repeat: Infinity, ease: "easeInOut" });
    }, [animate]);
    ...
    const clickAnim = useCallback(async () => {
      await animate(".icon-element", { y: -5 }, { duration: 0.1 }); await animate(".icon-element", { y: 0 }, { duration: 0.3, type: "spring", bounce: 0.7 });
    }, [animate]);
