  ...
  (
    ...
    return (
      <motion.svg
        ...
        whileTap={{ scale: 0.95 }}
      >
        <motion.circle cx="11" cy="11" r="8" className="icon-element" /><motion.line x1="21" x2="16.65" y1="21" y2="16.65" className="icon-element" /><motion.line x1="8" x2="14" y1="11" y2="11" className="icon-element" />
      </motion.svg>
    );
  }
);
