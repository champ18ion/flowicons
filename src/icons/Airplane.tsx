...
const Airplane = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    const start = useCallback(async () => {
      ...
      animate(
        ...
        { duration: 0.8, ease: "easeOut", repeat: loading ? Infinity : 0 },
      );
      ...
      animate(
        ...
        { duration: 0.8, ease: "easeOut", delay: 0.2, repeat: loading ? Infinity : 0 },
      );
    }, [animate, loading]);
