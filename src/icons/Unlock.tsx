...
const Unlock = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      <motion.svg
        ...
        whileTap={{ scale: 0.95 }}
      >
        <motion.rect width="18" height="11" x="3" y="11" rx="2" ry="2" className="icon-element" /><motion.path d="M7 11V7a5 5 0 0 1 9.9-1" className="icon-element" />
      </motion.svg>
    );
  }
);
