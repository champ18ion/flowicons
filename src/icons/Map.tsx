...
const Map = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    const hoverAnim = useCallback(() => {
      animate(".icon-element", { scale: [1, 1.02, 1] }, { duration: 1.2, repeat: Infinity, ease: "easeInOut" });
    }, [animate]);

    // 3. Click/Action Animation (One-Shot, Punchy)
    const clickAnim = useCallback(async () => {
      await animate(".icon-element", { scale: 0.95 }, { duration: 0.1 }); await animate(".icon-element", { scale: 1 }, { duration: 0.3, type: "spring", bounce: 0.6 });
    }, [animate]);
