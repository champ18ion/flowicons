...
const Calendar = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    const hoverAnim = useCallback(() => {
      animate(".icon-element", { rotate: [0, -3, 3, 0] }, { duration: 1.2, repeat: Infinity, ease: "easeInOut" });
    }, [animate]);

    // 3. Click/Action Animation (One-Shot, Punchy)
    const clickAnim = useCallback(async () => {
      await animate(".icon-element", { y: 2, scale: 0.9 }, { duration: 0.1 }); await animate(".icon-element", { y: 0, scale: 1 }, { duration: 0.2, type: "spring", bounce: 0.5 });
    }, [animate]);
