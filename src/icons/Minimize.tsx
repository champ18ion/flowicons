  ...
  (
    ...
    return (
      <motion.svg
        ...
        whileTap={{ scale: 0.95 }}
      >
        <motion.path d="M8 3v3a2 2 0 0 1-2 2H3" className="icon-element" /><motion.path d="M21 8h-3a2 2 0 0 1-2-2V3" className="icon-element" /><motion.path d="M3 16h3a2 2 0 0 1 2 2v3" className="icon-element" /><motion.path d="M16 21v-3a2 2 0 0 1 2-2h3" className="icon-element" />
      </motion.svg>
    );
  }
);
