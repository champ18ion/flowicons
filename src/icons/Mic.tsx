  ...
  (
    ...
    return (
      <motion.svg
        ...
        whileTap={{ scale: 0.95 }}
      >
        <motion.path d="M12 19v3" className="icon-element" /><motion.path d="M19 10v2a7 7 0 0 1-14 0v-2" className="icon-element" /><motion.rect x="9" y="2" width="6" height="13" rx="3" className="icon-element" />
      </motion.svg>
    );
  }
);
